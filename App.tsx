...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-app-base text-app-text flex overflow-hidden transition-colors duration-500">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed lg:static inset-y-0 left-0 z-[70] w-64 bg-app-surface border-r border-app-border transform transition-transform duration-300 ease-in-out
