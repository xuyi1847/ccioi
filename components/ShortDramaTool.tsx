...
const sampleProject = (): Project => {
  ...
  const specs: Array<[string, string, string, string, string, string[]]> = [
    ['暴雨中的便利店', '便利店外景', '高位全景缓慢下降并推进', '林夏旁白：爸爸失踪后的第十年，我又梦见了那个雨夜。', 'Opening shot. A small 24-hour convenience store alone on an empty city street at midnight during violent rain, cyan neon reflected on black wet asphalt, warm fluorescent light inside, camera descends and slowly pushes toward the entrance, thunder, wind and heavy rain, photorealistic cinematic suspense.', []],
    ['林夏独自值班', '便利店货架区', '侧面中景平稳跟拍', '林夏：下班前，再撑最后一分钟。', 'Inside the same store moments later. The young Chinese clerk Lin Xia, shoulder-length black hair, cream store uniform and blue name badge, restocks shelves while looking at a worn photograph of herself with her missing father beside the register. Camera tracks beside her, the digital clock reads 23:59, cinematic realism.', [lin]],
    ['门铃在午夜响起', '便利店入口', '从林夏肩后快速转向门口', '林夏：欢迎光临……先生，我们是不是见过？', 'Direct continuation as the clock reaches midnight. Over Lin Xia’s shoulder, the entrance bell rings and a slim middle-aged Chinese man in a soaked dark gray trench coat and old black fedora enters. His face resembles the father in her photograph, but she does not recognize him yet. Water drips onto the floor, thunder.', [lin, manager]],
    ...
    ['顾客消失在雨里', '便利店入口', '长焦跟拍到玻璃门外', '林夏：等等！你到底是谁？', 'Direct continuation. Lin Xia calls after the mysterious man as he exits into the heavy rain. The camera follows through the glass door, but after one flash of lightning the street is empty. She looks down and realizes the brass key remains in her hand, distant thunder.', [lin, manager]],
    ...
    ['监控里的未来', '收银台监控屏', '屏幕特写缓慢推近', '未来林夏（监控中）：别开门！我已经错过一次了。', 'Direct continuation. On the security monitor, live footage shows Lin Xia at the back door and an older exhausted version of herself beside her, although the real aisle is empty. The older woman points urgently at the clock and speaks through monitor static. Camera pushes into the glitching screen.', [lin, futureLin]],
    ['来自明天的电话', '收银台', '环绕中近景', '林夏：你是谁？　未来林夏：我是十年后的你。门后是爸爸。', 'The store phone rings immediately after the monitor warning. Lin Xia answers with trembling hands. The same older female voice explains she is Lin Xia ten years in the future and the man behind the door is their missing father. Camera circles Lin Xia; clock flickers at 00:00, phone static.', [lin, futureLin]],
    ['时间开始倒流', '便利店全景', '快速拉远', '未来林夏（电话）：十二点开门，时间会永远重来。', 'As the warning continues on speakerphone, time reverses inside the store: spilled water climbs upward, a fallen can returns to a shelf, clock digits run backward. Lin Xia remains still clutching the key and listening. Camera rapidly pulls back, reversed sounds and electrical hum.', [lin, futureLin]],
    ['门缝后的男人', '后门', '低机位贴近门缝', '父亲（门后）：小夏，是爸爸。别开门……还不到时候。', 'Direct continuation at the back door. Cold blue light leaks through the bottom gap and the wounded hand of the mysterious man appears. He calls Lin Xia by her childhood nickname and warns her to wait. She recognizes the crescent-shaped scar on his hand, muffled rain roaring behind the door.', [lin, manager]],
    ['旧照片的真相', '员工休息室', '照片特写转焦到林夏', '林夏：照片里爸爸的手上，也有这道月牙疤。', 'Lin Xia runs to the locker and retrieves the worn family photograph seen earlier. Rack focus from the crescent-shaped scar on her father’s hand in the photo to the same hand beneath the back door. Her doubt becomes certainty; the three knocks repeat.', [lin, manager]],
    ...
    ['等待最后一分钟', '后门走廊', '正面缓慢后退', '未来林夏：我不敢再赌。　林夏：爸爸等了十年，我只等十五秒。', 'Direct continuation. Lin Xia walks to the back door while the clock counts from 00:00:45. Future Lin tries to stop her, but young Lin calmly grips the key and decides to wait until 00:01. Camera retreats before them, lights shut off one by one, heartbeat follows clock ticks.', [lin, futureLin]],
    ['午夜裂缝袭来', '后门走廊', '剧烈手持与快速摇镜', '未来林夏：它们来了！　林夏：看着秒针，别松手！', 'At 00:00:59 black liquid shadows burst through cracks and race toward them. Future Lin braces the door while young Lin shields the key and keeps watching the clock. Violent handheld camera, alarms and roaring wind, their coordinated action clearly continues the countdown.', [lin, futureLin]],
    ...
    ['清晨新的开始', '便利店外景与柜台', '从钥匙拉远至晨景', '林夏旁白：十年前他没能回家。今天，我们一起等天亮。', 'Final shot begins on the brass key beside the same family photograph, completing the visual motif. Camera pulls back through the storefront into sunrise. Inside, Lin Xia pours hot tea for her father and they sit together for the first time in ten years, warm light, complete hopeful ending.', [lin, manager]],
  ];
  return {
    name: 'LTX 2分钟样例·午夜钥匙',
    data: {
      ...
      script: '第1集《午夜钥匙》（约2分钟）\n\n【开场】暴雨午夜，林夏独自在便利店值班。她看着与失踪父亲的旧照片，准备下班。\n林夏旁白：爸爸失踪后的第十年，我又梦见了那个雨夜。\n\n【来客】零点门铃响起，一个像极了父亲的男人进店，把黄铜钥匙留在柜台。\n男人：今晚十二点以后，不要打开后门。\n林夏：等等！你到底是谁？\n男人消失，后门随即传来三次敲门。\n\n【警告】监控中出现十年后的林夏，电话也同时响起。\n未来林夏：我是十年后的你。门后是爸爸。十二点开门，时间会永远重来。\n门后的男人伸出带月牙疤的手。\n父亲：小夏，是爸爸。别开门……还不到时候。\n林夏用旧照片确认了父亲身份。\n\n【选择】未来林夏现身，说明自己当年在零点开门，害整座城市困在午夜。林夏发现钥匙刻着“00:01”。\n林夏：不是不能开，是要等到零点零一分。\n未来林夏：我不敢再赌。\n林夏：爸爸等了十年，我只等十五秒。\n\n【高潮】黑影从门缝袭来，两人一起守住门。时钟跳到00:01，林夏转动钥匙。黑影消散，门外出现晨光，父亲获救。\n父亲：小夏，我终于回来了。\n未来林夏：这一次，你做对了。\n\n【结尾】未来林夏消失，雨停了。林夏给父亲倒上一杯热茶。\n林夏旁白：十年前他没能回家。今天，我们一起等天亮。',
